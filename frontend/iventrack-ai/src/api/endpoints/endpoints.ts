...
export const PREDICCION = {
  GET_BY_PRODUCT: (productoId: number) => `${BASE_URL}/prediccion/${productoId}`,
  RECALCULATE: (productoId: number) => `${BASE_URL}/prediccion/${productoId}/recalcular`,
  GET_ALL_ANALYSIS: `${BASE_URL}/prediccion/analisis`,
} as const;